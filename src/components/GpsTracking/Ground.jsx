...
const Ground = () => {
  ...
  return (
    ...
    <div className='absolute lg:bottom-95 md:bottom-70 bottom-0 z-20'>
        <h1 style={{color: MY_COLORS.white}} className='font-bold text-6xl' >{t('gpsT.titleRound')} </h1>

     
    </div>
    <div className='absolute items-center justify-center flex lg:bottom-80 md:bottom-50 z-20'>
         <p style={{color: MY_COLORS.secondaryGreen}} className='font-bold text-6xl '>
            {t('gpsT.titleRound2')} 
        </p>
    </div>
...
<div 
    className='absolute 
                ...
                lg:bottom-40 md:bottom-50 
                z-20 
                w-full max-w-lg px-4' // AJOUTÉ : w-full, max-w-md et px-4 (padding pour ne pas coller aux bords)
> 

    <p 
        style={{color: MY_COLORS.white}} 
        className='font-medium text-center text-4xl whitespace-normal' // AJOUTÉ : text-center et whitespace-normal (pour assurer le wrap)
    >
