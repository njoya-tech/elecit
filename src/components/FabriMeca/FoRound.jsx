...
const FoRound = () => {
  ...
  return (
    <div className='items-center w-full md:w-screen h-screen lg:h-[100px] md:h-[60px] relative overflow-visible flex justify-center'>
        ...
        <div className="absolute lg:-top-20 lg:left-320 z-30 md:left-190 md:-top-70">
          <motion.img 
            src={rail} 
            alt="engrenage" 
            className="w-70 h-45"
    ...
    <div className='absolute lg:bottom-85 md:bottom-70 bottom-0 z-20'>
        <h1 style={{color: MY_COLORS.white}} className='font-bold text-4xl' >{t('fab.titleRound')} ? </h1>

     
    </div>
      <div className='absolute lg:bottom-70 md:bottom-50 bottom-0 z-19'>
        <h1 style={{color: MY_COLORS.white}} className='font-bold text-4xl' >{t('fab.titleRound2')}  <span className='' style={{ color: MY_COLORS.green}}>  {t('fab.sub')} ? </span> </h1>
