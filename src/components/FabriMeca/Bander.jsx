        ...
        >
          <div className="flex md:flex-row flex-col items-center gap-5 md:py-0 py-8">
            ...
            <div className="flex-1 md:pl-10 pl-4 pr-4 relative z-10">
              ...
              <h2 className="md:text-4xl text-2xl font-bold md:mb-2 mb-3 text-white">
                {t('fm.title')}
              </h2>

              <h3 
                className="md:text-xl text-lg font-bold md:mt-5 mt-3"
                style={{ color: MY_COLORS.white }}
              >
                {t('fm.subtitle')}
              </h3>

              <p className="text-white md:mb-8 mb-4 font-semibold text-sm md:max-w-md">
                {t('fm.description')}
              </p>
