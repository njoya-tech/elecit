      ...
      <nav className="shadow-sm p-2 sm:p-3" style={{background: MY_COLORS.white}}>
        <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
          <div className="flex items-center justify-between h-16 sm:h-20">
                    ...
                    {item.dropdown ? (
                      ...
                      >
                        ...
                        >
                          {t(item.key)}
                          <svg
                            className={`w-3 h-3 xl:w-4 xl:h-4 transition-transform duration-200 ${openDropdown === item.key ? 'rotate-180' : ''}`}
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
            ...
            {/* Navigation Tablette Moyenne (768px - 1024px) */}
            <div className="hidden md:flex lg:hidden items-center justify-center flex-1 ml-4">
                  ...
                  {item.dropdown ? (
                    <>
                      <button
                        ...
                        className="w-full flex items-center justify-between px-3 py-2 rounded-md text-sm sm:text-base font-medium text-gray-700 hover:text-green-600 hover:bg-gray-50 transition-colors duration-200"
                      >
                        <span>{t(item.key)}</span>
                        <svg
                          className={`w-4 h-4 sm:w-5 sm:h-5 transition-transform duration-200 ${mobileDropdowns[item.key] ? 'rotate-180' : ''}`}
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
