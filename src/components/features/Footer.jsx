            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-8 md:gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2 sm:space-y-3">
                  <li>
                    <a href="/solutions/mechanical-fabrication" className="text-gray-300 hover:text-white transition text-xs sm:text-sm">
                  ...
                  <li>
                    <a href="/solutions/it-services" className="text-gray-300 hover:text-white transition text-xs sm:text-sm">
                      {t('footer.services.itServices')}
                    </a>
                  </li>
                  <li>
                    <a href="/solutions/design-office" className="text-gray-300 hover:text-white transition text-xs sm:text-sm">
                      {t('footer.services.designOffice')}
                    </a>
                  </li>
                  <li>
                    <a href="/solutions/after-sales" className="text-gray-300 hover:text-white transition text-xs sm:text-sm">
