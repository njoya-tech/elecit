...
import { logo, g1, rail, te } from '../../assets'
...
const Footer = () => {
  ...
  return (
    <footer style={{ backgroundColor: MY_COLORS.black }} className="text-white relative overflow-hidden">
      ...
      {/* Engrenages décoratifs en haut - Toujours visibles */}
      <div className="absolute top-2 sm:top-3 md:top-5 left-4 sm:left-2 md:-left-5 lg:left-80 z-0">
        <motion.img
          src={rail}
          alt="engrenage"
      ...
      <div className="absolute top-8 sm:top-10 md:top-14 lg:top-20 left-16 sm:left-20 md:-left-5 lg:left-70 z-0">
        <motion.img
          src={rail}
          alt="engrenage"
          className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 lg:w-17 lg:h-17"
          animate={{ rotate: 360 }}
          transition={{
            duration: 6,
            ease: "linear",
      ...
      {/* Bandeau vert - Pleine largeur sur mobile, avec colonnes sur desktop */}
      <div className='grid grid-cols-1 md:grid-cols-12 gap-0'>
        {/* Zone gauche - Cachée sur mobile */}
        <div className="hidden md:block md:col-span-3 lg:col-span-3"></div>

        <div className="col-span-1 md:col-span-7 lg:col-span-6">
          <div
            style={{ backgroundColor: MY_COLORS.green }}
            className="py-4 sm:py-5 md:py-3 lg:py-7 px-4 sm:px-5 md:px-6 relative z-10"
          >
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6">
              {/* Partie gauche - Globe et texte */}
              <div className="flex items-center gap-3 sm:gap-4 md:gap-5 lg:gap-7">
                <motion.div
              ...
              <div className='flex items-center gap-3 sm:gap-4 md:gap-6 lg:gap-8 text-white'>
                ...
                <a
                  href="tel:+237650263982"
                  style={{ backgroundColor: MY_COLORS.black }}
                  className="px-3 py-1.5 sm:px-4 sm:py-2 md:px-5 md:py-2 lg:px-6 lg:py-2 rounded-full text-white font-bold text-xs sm:text-sm md:text-base hover:opacity-90 transition whitespace-nowrap"
                >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-5 md:px-6 py-8 sm:py-10 md:py-12 relative z-10">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-8 md:gap-8">
              ...
              {/* Colonne 2 - Services */}
              <div>
                <h3 className="text-white font-bold text-base sm:text-lg mb-3 sm:mb-4">{t('footer.services.title')}</h3>
                <ul className="space-y-2 sm:space-y-3">
                  <li>
                    <a href="/solutions/fabrication-mecanique" className="text-gray-300 hover:text-white transition text-xs sm:text-sm">
                      {t('footer.services.mechanicalFabrication')}
                    </a>
                  </li>
                  <li>
                    <a href="/solutions/smart-building" className="text-gray-300 hover:text-white transition text-xs sm:text-sm">
                      {t('footer.services.smartBuilding')}
                    </a>
                  </li>
                  <li>
                    <a href="/solutions/gps-tracking" className="text-gray-300 hover:text-white transition text-xs sm:text-sm">
                      {t('footer.services.gpsTracking')}
                    </a>
                  </li>
                  <li>
                    <a href="/solutions/it-data-processing" className="text-gray-300 hover:text-white transition text-xs sm:text-sm">
                      {t('footer.services.itServices')}
                    </a>
                  </li>
                  <li>
                    <a href="/solutions/bureau-etude" className="text-gray-300 hover:text-white transition text-xs sm:text-sm">
                      {t('footer.services.designOffice')}
                    </a>
                  </li>
                  <li>
                    <a href="/solutions/sav" className="text-gray-300 hover:text-white transition text-xs sm:text-sm">
              ...
              <div>
                <h3 className="text-white font-bold text-base sm:text-lg mb-3 sm:mb-4">{t('footer.newsletter.title')}</h3>
                <p className="text-gray-300 text-xs sm:text-sm mb-4 sm:mb-5 md:mb-6 leading-relaxed">
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  {message.text && (
                    <p
                      className={`text-xs sm:text-sm ${message.type === 'success'
                          ? 'text-green-400'
                          : 'text-red-400'
                        }`}
                    >
          ...
          {/* Copyright */}
          <div
            className="border-t py-3 sm:py-4 px-4 sm:px-5 md:px-6 border-dashed relative z-10"
            style={{ borderColor: MY_COLORS.green }}
          >
            <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4">
              <p className="text-gray-400 text-xs sm:text-sm flex items-center gap-2">
                <span className="w-4 h-4 sm:w-5 sm:h-5 rounded-full border-2 border-gray-400 flex items-center justify-center text-xs">
                  ©
                </span>
                {t('footer.copyright.text')}
              </p>
              <div className="flex gap-4 sm:gap-6">
                <a href="/politique-confidentialite" className="text-gray-400 hover:text-white text-xs sm:text-sm transition">
                  {t('footer.copyright.privacyPolicy')}
                </a>
                <a href="/mentions-legales" className="text-gray-400 hover:text-white text-xs sm:text-sm transition">
        ...
        {/* Zone droite - Cachée sur mobile */}
        <div className="hidden md:block md:col-span-3 lg:col-span-3"></div>
      </div>

      {/* Engrenage décoratif en bas à droite - Toujours visible */}
      <div className="absolute bottom-4 sm:bottom-6 md:bottom-10 lg:bottom-15 right-4 sm:right-8 md:right-16 lg:right-25 z-0">
        <motion.img
          src={rail}
          alt="engrenage"
