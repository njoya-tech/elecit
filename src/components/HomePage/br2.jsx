...
const Footer = () => {
  ...
  return (
    <footer style={{ backgroundColor: MY_COLORS.black }} className="text-white relative overflow-hidden">
      {/* Engrenages décoratifs haut - Cachés sur mobile */}
      <div className='hidden lg:block'>
        <div className="absolute top-5 left-60">
          <motion.img 
            src={rail} 
            alt="engrenage" 
            className="w-20 h-20 xl:w-30 xl:h-30"
            animate={{ rotate: 360 }}
            transition={{ 
              duration: 6, 
              ease: "linear", 
        ...
        <div className="absolute top-20 left-90">
          <motion.img 
            src={rail} 
            alt="engrenage" 
            className="w-12 h-12 xl:w-17 xl:h-17"
            animate={{ rotate: 360 }}
            transition={{ 
              duration: 6, 
              ease: "linear", 
      ...
      <div className='grid grid-cols-1 md:grid-cols-12 gap-0'>
        {/* Zone gauche - Espacement responsive */}
        ...
        <div className="col-span-1 md:col-span-8 lg:col-span-6">
          ...
          <div 
            ...
            className="py-4 sm:py-5 md:py-6 lg:py-7 px-3 sm:px-4 md:px-6 flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6 relative"
          >
              ...
              <div>
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <button
                    ...
                    className="w-full py-2 rounded border-2 font-semibold hover:bg-opacity-20 transition text-xs sm:text-sm"
          ...
          {/* Copyright */}
          <div 
            className="border-t py-3 sm:py-4 px-3 sm:px-4 md:px-6 border-dashed"
            style={{ borderColor: MY_COLORS.green }}
          >
        ...
        {/* Zone droite - Espacement responsive */}
        <div className="hidden md:block md:col-span-2 lg:col-span-3"></div>
      </div>

      {/* Engrenage décoratif bas - Caché sur mobile et tablette */}
      <div className="absolute bottom-15 right-25 hidden xl:block">
        <motion.img 
          src={rail} 
          alt="engrenage" 
