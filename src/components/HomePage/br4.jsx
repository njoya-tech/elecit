    ...
    <div className="relative w-full mb-20">
      ...
      >
        <div className="absolute inset-0 flex flex-col items-center justify-center px-8 text-center">
          ...
          <button 
            className="px-8 py-3 rounded-full border-2 text-white font-medium hover:bg-opacity-20 transition-all"
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 w-full max-w-5xl px-4">
        <div className="bg-white shadow-lg flex justify-center rounded-l-full rounded-r-full overflow-hidden">
          {tabs.map((tab, index) => (
            <button
              key={tab.id}
...
// Composant Carousel avec changement de contenu selon le tab
